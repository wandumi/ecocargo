                ...
                <div class="card-body">
                  <div class="chart">
                    <div class="row col-md">
                        <div class="col-md-6">
                            <ul class="list-group">
                                <li class="list-group-item head">Name</li>
                                <li class="list-group-item head">Email</li>
                                <li class="list-group-item head">Phone</li>
                                <li class="list-group-item head">Address</li>
